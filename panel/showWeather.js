...
async function getWeather() {
    let weather= await fetch("https://api.openweathermap.org/data/2.5/weather?lat=49.3487181&lon=16.4243806&appid=a296927699ef78adbcd0efff41c64f09")
    weather= await weather.json();
    console.log(weather)
    return {
        "pocasi":    weather.weather[0].main,
